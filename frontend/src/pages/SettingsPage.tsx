...
import { Save, Loader2, Check, Github, Bot, Database, SplitSquareVertical, GitBranch, Palette } from 'lucide-react';
...
export function SettingsPage() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden p-6">
      ...
      {error && (
        <div className="mb-4 p-4 bg-destructive/10 text-destructive rounded-lg text-sm shrink-0">
          {error}
        </div>
      )}

      {/* Tabs */}
      <Tabs defaultValue="github" className="flex-1 flex flex-col overflow-hidden">
        <TabsList>
          ...
          <TabsTrigger value="embedder">
            <Database className="w-4 h-4 mr-2" />
            向量嵌入
          </TabsTrigger>
          <TabsTrigger value="text-split">
